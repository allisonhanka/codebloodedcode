...
@Autonomous(name="AutoDepotVuforia", group="Test")

public class AutoDepotVuforia extends LinearOpMode {
    ...
    public void runOpMode() {
      ...
      if (tfod != null) {
        ...
        encoderDrive(DRIVE_SPEED,  -50,  -50, 60.0);  // S1: backwards 25 Inches with 5 Sec timeout
        position = 0.9;
        sleep(1000);
